...
include "database/db_con.php";
  $cat=$_GET['cat'];
  $product_query = "SELECT PRODUCTS.product_id, PRODUCTS.product_name, PRODUCTS.product_details, PRODUCTS.sell_price,PRODUCT_IMAGE.image, STOCKS.in_stock FROM PRODUCTS INNER JOIN PRODUCT_IMAGE ON PRODUCTS.product_id = PRODUCT_IMAGE.product_id INNER JOIN STOCKS ON STOCKS.product_id=PRODUCTS.product_id INNER JOIN CATEGORY ON product_category=category_name WHERE category_name LIKE '%$cat%'";
$output="";
