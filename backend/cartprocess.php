...
IF ( $_POST['action'] == 'reguser' ) {
    ...
    $check_for = "SELECT * FROM CART WHERE product_id='$id' AND cust_id='$cust_id'";
    ...
    if ( $count > 0 ) {
        $newQty = $count + $qty;
        $update_query = "UPDATE CART SET quantity='$newQty' WHERE product_id='$id' AND cust_id='$cust_id'";
        ...
        $insert_query = "INSERT INTO CART(product_id, cust_id, quantity) VALUES ('$id','$cust_id','$qty')";
